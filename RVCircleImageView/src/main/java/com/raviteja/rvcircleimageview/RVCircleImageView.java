package com.raviteja.rvcircleimageview;
...
/**
 * Created by Raviteja Emandi on 09,May,2025
 **/
public class RVCircleImageView extends ImageView {
    ...
    public RVCircleImageView(Context context) {
        super(context);
    ...
    public static void initialize() {
        Log.e("RVCircleImageView", "RVCircleImageViewSDK initialized Successfully");
    }

    public RVCircleImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RVCircleImageView(Context context, AttributeSet attrs, int defStyle) {
